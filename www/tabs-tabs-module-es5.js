      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            /*! import() | discussion-discussion-module */
            "discussion-discussion-module").then(__webpack_require__.bind(null,
            /*! ../discussion/discussion.module */
            "./src/app/discussion/discussion.module.ts")).then(function (m) {
              return m.DiscussionPageModule;
            });
          }
        }, {
          path: '',
